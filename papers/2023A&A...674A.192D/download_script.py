...
for wavelength in aia_wavelengths:
    aia_query = Fido.search(aia_time_range, a.Instrument('AIA'), a.Wavelength(wavelength))
    print(aia_query)
...
euvi_query = Fido.search(euvi_time_range, a.Instrument('SECCHI'), a.Detector('EUVI'), a.Wavelength(euvi_wavelength))
print(euvi_query)
# Uncomment the following line to fetch the data
