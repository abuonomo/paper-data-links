...
secchi_cme1_query = Fido.search(a.Time(cme1_secchi_start, cme1_secchi_end), a.Instrument('SECCHI'))
secchi_cme2_query = Fido.search(a.Time(cme2_secchi_start, cme2_secchi_end), a.Instrument('SECCHI'))
